...
module KeycloakAdminClient
  class ClientRepresentation
    ...
    attr_accessor :oauth2_device_authorization_grant_enabled
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KeycloakAdminClient::ClientRepresentation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KeycloakAdminClient::ClientRepresentation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'oauth2_device_authorization_grant_enabled')
        self.oauth2_device_authorization_grant_enabled = attributes[:'oauth2_device_authorization_grant_enabled']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          oauth2_device_authorization_grant_enabled == o.oauth2_device_authorization_grant_enabled &&
