...
module KeycloakAdminClient
  class RealmRepresentation
    ...
    attr_accessor :client_policies

    attr_accessor :client_profiles
    ...
    attr_accessor :o_auth2_device_code_lifespan

    attr_accessor :o_auth2_device_polling_interval

    attr_accessor :oauth2_device_code_lifespan

    attr_accessor :oauth2_device_polling_interval
    ...
    def self.openapi_types
      {
        ...
        :'not_before' => :'Integer',
        :'o_auth2_device_code_lifespan' => :'Integer',
        :'o_auth2_device_polling_interval' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KeycloakAdminClient::RealmRepresentation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KeycloakAdminClient::RealmRepresentation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'client_policies')
        self.client_policies = attributes[:'client_policies']
      end

      if attributes.key?(:'client_profiles')
        self.client_profiles = attributes[:'client_profiles']
      end
      ...
      if attributes.key?(:'o_auth2_device_code_lifespan')
        self.o_auth2_device_code_lifespan = attributes[:'o_auth2_device_code_lifespan']
      end

      if attributes.key?(:'o_auth2_device_polling_interval')
        self.o_auth2_device_polling_interval = attributes[:'o_auth2_device_polling_interval']
      end

      if attributes.key?(:'oauth2_device_code_lifespan')
        self.oauth2_device_code_lifespan = attributes[:'oauth2_device_code_lifespan']
      end

      if attributes.key?(:'oauth2_device_polling_interval')
        self.oauth2_device_polling_interval = attributes[:'oauth2_device_polling_interval']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          client_policies == o.client_policies &&
          client_profiles == o.client_profiles &&
          ...
          o_auth2_device_code_lifespan == o.o_auth2_device_code_lifespan &&
          o_auth2_device_polling_interval == o.o_auth2_device_polling_interval &&
          oauth2_device_code_lifespan == o.oauth2_device_code_lifespan &&
          oauth2_device_polling_interval == o.oauth2_device_polling_interval &&
