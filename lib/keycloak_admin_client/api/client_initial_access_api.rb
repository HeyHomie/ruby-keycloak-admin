  ...
  class ClientInitialAccessApi
    ...
    def realm_clients_initial_access_get_with_http_info(realm, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ClientInitialAccessApi.realm_clients_initial_access_get",
    ...
    def realm_clients_initial_access_id_delete_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ClientInitialAccessApi.realm_clients_initial_access_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_clients_initial_access_post_with_http_info(realm, client_initial_access_create_presentation, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(client_initial_access_create_presentation)

      # return_type
      return_type = opts[:debug_return_type] || 'ClientInitialAccessPresentation'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['access_token']

      new_options = opts.merge(
        :operation => :"ClientInitialAccessApi.realm_clients_initial_access_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
