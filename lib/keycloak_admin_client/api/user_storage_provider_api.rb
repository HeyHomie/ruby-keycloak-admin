  ...
  class UserStorageProviderApi
    ...
    def id_name_get_with_http_info(id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UserStorageProviderApi.id_name_get",
    ...
    def realm_user_storage_id_name_get_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UserStorageProviderApi.realm_user_storage_id_name_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_user_storage_id_remove_imported_users_post_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UserStorageProviderApi.realm_user_storage_id_remove_imported_users_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_user_storage_id_sync_post_with_http_info(realm, id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SynchronizationResult'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['access_token']

      new_options = opts.merge(
        :operation => :"UserStorageProviderApi.realm_user_storage_id_sync_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_user_storage_id_unlink_users_post_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UserStorageProviderApi.realm_user_storage_id_unlink_users_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_user_storage_parent_id_mappers_id_sync_post_with_http_info(realm, parent_id, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UserStorageProviderApi.realm_user_storage_parent_id_mappers_id_sync_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
