  ...
  class ComponentApi
    ...
    def realm_components_get_with_http_info(realm, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ComponentApi.realm_components_get",
    ...
    def realm_components_id_delete_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ComponentApi.realm_components_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_components_id_get_with_http_info(realm, id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ComponentRepresentation'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['access_token']

      new_options = opts.merge(
        :operation => :"ComponentApi.realm_components_id_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_components_id_put_with_http_info(realm, id, component_representation, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(component_representation)
      ...
      new_options = opts.merge(
        :operation => :"ComponentApi.realm_components_id_put",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_components_id_sub_component_types_get_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ComponentApi.realm_components_id_sub_component_types_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_components_post_with_http_info(realm, component_representation, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ComponentApi.realm_components_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
