  ...
  class GroupsApi
    ...
    def realm_groups_count_get_with_http_info(realm, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_count_get",
    ...
    def realm_groups_get_with_http_info(realm, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_id_children_post_with_http_info(realm, id, group_representation, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(group_representation)
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_id_children_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_id_delete_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_id_delete",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_id_get_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_id_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_id_management_permissions_get_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_id_management_permissions_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_id_management_permissions_put_with_http_info(realm, id, management_permission_reference, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_id_management_permissions_put",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_id_members_get_with_http_info(realm, id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_id_members_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_id_put_with_http_info(realm, id, group_representation, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_id_put",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def realm_groups_post_with_http_info(realm, group_representation, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"GroupsApi.realm_groups_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
