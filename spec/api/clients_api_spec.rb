...
# Unit tests for KeycloakAdminClient::ClientsApi
...
describe 'ClientsApi' do
  ...
  describe 'test an instance of ClientsApi' do
    it 'should create an instance of ClientsApi' do
      expect(@api_instance).to be_instance_of(KeycloakAdminClient::ClientsApi)
    end
  end
  ...
  # unit tests for realm_clients_id_evaluate_scopes_generate_example_id_token_get
  ...
  # @option opts [String] :user_id 
  # @return [IDToken]
  describe 'realm_clients_id_evaluate_scopes_generate_example_id_token_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_clients_id_evaluate_scopes_generate_example_userinfo_get
  ...
  describe 'realm_clients_id_evaluate_scopes_generate_example_userinfo_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
