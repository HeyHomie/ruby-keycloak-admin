...
# Unit tests for KeycloakAdminClient::RealmsAdminApi
...
describe 'RealmsAdminApi' do
  ...
  describe 'test an instance of RealmsAdminApi' do
    it 'should create an instance of RealmsAdminApi' do
      expect(@api_instance).to be_instance_of(KeycloakAdminClient::RealmsAdminApi)
    end
  end
  ...
  # unit tests for realm_client_policies_policies_get
  # @param realm realm name (not id!)
  # @param [Hash] opts the optional parameters
  # @return [ClientPoliciesRepresentation]
  describe 'realm_client_policies_policies_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_client_policies_policies_put
  # @param realm realm name (not id!)
  # @param client_policies_representation 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'realm_client_policies_policies_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_client_policies_profiles_get
  # @param realm realm name (not id!)
  # @param [Hash] opts the optional parameters
  # @option opts [Boolean] :include_global_profiles 
  # @return [ClientProfilesRepresentation]
  describe 'realm_client_policies_profiles_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_client_policies_profiles_put
  # @param realm realm name (not id!)
  # @param client_profiles_representation 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'realm_client_policies_profiles_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # unit tests for realm_localization_get
  # @param realm realm name (not id!)
  # @param [Hash] opts the optional parameters
  # @return [Array<Hash<String, Object>>]
  describe 'realm_localization_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_localization_locale_delete
  # @param realm realm name (not id!)
  # @param locale 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'realm_localization_locale_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_localization_locale_get
  # @param realm realm name (not id!)
  # @param locale 
  # @param [Hash] opts the optional parameters
  # @return [Hash<String, Object>]
  describe 'realm_localization_locale_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_localization_locale_key_delete
  # @param realm realm name (not id!)
  # @param locale 
  # @param key 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'realm_localization_locale_key_delete test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_localization_locale_key_get
  # @param realm realm name (not id!)
  # @param locale 
  # @param key 
  # @param [Hash] opts the optional parameters
  # @return [String]
  describe 'realm_localization_locale_key_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_localization_locale_key_put
  # @param realm realm name (not id!)
  # @param locale 
  # @param key 
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'realm_localization_locale_key_put test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_localization_locale_patch
  # @param realm realm name (not id!)
  # @param locale 
  # @param request_body 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'realm_localization_locale_patch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for realm_localization_locale_post
  # Import localization from uploaded JSON file
  # @param realm realm name (not id!)
  # @param locale 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'realm_localization_locale_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
